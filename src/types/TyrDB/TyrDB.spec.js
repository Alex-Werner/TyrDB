...
describe('TyrDB - Class', () => {
  ...
  it('should work', function (done) {
    ...
    expect(tyr.databaseVersion).to.deep.equal('3.0.2');
    tyr.on('ready', () => {
  ...
  it('should serialize Meta of TyrDB', async function () {
    const expected = {"options":{"path":".db","autoInitialize":true,"autoConnect":true},"state":{"isConnected":true,"isConnecting":false},"adapter":{"name":"MemoryAdapter"},"databases":[],"databaseVersion":"3.0.2"};
