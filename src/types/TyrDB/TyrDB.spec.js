...
describe('TyrDB - Class', () => {
  ...
  it('should work', function (done) {
    ...
    expect(tyr.databaseVersion).to.deep.equal(pkgVersion);
    tyr.on('ready', () => {
  ...
  it('should serialize Meta of TyrDB', async function () {
    const expected = {"options":{"path":".db","autoInitialize":true,"autoConnect":true},"state":{"isConnected":true,"isConnecting":false},"adapter":{"name":"MemoryAdapter"},"databases":[],"databaseVersion":pkgVersion};
